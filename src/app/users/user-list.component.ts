...
*/
  ...
  editarUsuario() {
    ...
    //this.updateUserForm.controls['estadoUsuario'].setValue(this._usuarioSelected[0].estado);
    this.updateUserForm.controls['tipoUsuario'].setValue(this._usuarioSelected[0].idTipo);
